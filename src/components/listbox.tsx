    ...
    <Headless.Listbox {...props} multiple={false}>
      ...
      >
        <Headless.ListboxSelectedOption
          ...
          placeholder={
            placeholder && (
              <span className={withPrefix("block truncate text-zinc-500")}>
                {placeholder}
              </span>
            )
          }
  ...
  return (
    <Headless.ListboxOption as={Fragment} {...props}>
      {({ selectedOption }) => {
        if (selectedOption) {
          return (
            <div className={withPrefix(className, sharedClasses)}>
              {children}
            </div>
          );
        }
        ...
        return (
          ...
          >
            ...
            <span
              className={withPrefix(className, sharedClasses, "col-start-2")}
            >
              {children}
            </span>
          </div>
...
export function ListboxDescription({
  ...
  return (
    ...
    >
      <span className={withPrefix("flex-1 truncate")}>{children}</span>
    </span>
  );
}
