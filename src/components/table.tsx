...
export function Table({
  ...
  return (
    ...
    >
      <div className={withPrefix("flow-root")}>
        <div
          {...props}
...
export function TableHead({
  ...
  return (
    <thead
      {...props}
      className={withPrefix(className, "text-zinc-500 dark:text-zinc-400")}
    />
  );
}
    ...
    >
      {href && (
        <Link
          ...
          className={withPrefix("absolute inset-0 focus:outline-hidden")}
        />
      )}
      {children}
    </td>
